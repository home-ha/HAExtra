...
class ModbusClimate(ClimateDevice):
    ...
    def operation_list(self):
        ...
        return self.modes_list(ModbusClimate._operation_list)
    ...
    def fan_list(self):
        ...
        return self.modes_list(ModbusClimate._fan_list)
    ...
    def swing_list(self):
        ...
        return self.modes_list(ModbusClimate._swing_list)
